...
export class ReservationComponent implements OnInit {
  ...
  datesDisponibles$: Observable<string[]> = new Observable<string[]>; // Initialise le tableau des dates disponibles
  horairesDisponibles$: Observable<{ [date: string]: string[] }> = new Observable<{ [date: string]: string[] }>; // Initialise un objet pour stocker les horaires disponibles pour chaque date
  ...
  ngOnInit(): void {
    this.datesDisponibles$ = this.apiService.getDatesDisponibles();
